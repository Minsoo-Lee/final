...
public class Calculator {
	...
	public void check() {
		if (application.Main.Calc_visible == false) frame.setVisible(false);
		else if (application.Main.Calc_visible == true) frame.setVisible(true);
	}
	/**
	...
	/*public void check_1() {
		if (application.Main.B == false) window.frame.setVisible(false);
		else if (application.Main.B == true) window.frame.setVisible(true);
	}*/
	...
	private void initialize() {
		...
		JButton bntDot = new JButton("C");
		bntDot.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				answer.setText("");
			}
